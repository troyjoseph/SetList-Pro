...
export const EDITOR_ROW = {
  ...
  TITLE_BTN: "font-medium text-gray-900 truncate hover:text-indigo-600 hover:underline decoration-dotted underline-offset-2 transition-colors text-left",
  SUBTITLE: "text-xs text-gray-500 truncate",
  SUBTITLE_BTN: "text-xs text-gray-500 truncate hover:text-indigo-500 hover:underline decoration-dotted underline-offset-2 transition-colors text-left",
  ...
  KEY_INPUT: (isChange: boolean) => `text-xs font-mono px-1 py-0.5 rounded border w-7 text-center focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400 outline-none ${isChange ? 'bg-yellow-200 text-yellow-900 font-bold border-yellow-300' : 'bg-white text-gray-500 border-gray-200'}`,
