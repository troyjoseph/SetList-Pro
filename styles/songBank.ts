export const SONGBANK = {
  ...
  CONTROLS: {
    CONTAINER: "p-4 border-b bg-gray-50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0",
    SELECT: "border border-gray-300 rounded-md text-sm py-1.5 px-3 bg-white text-gray-900",
    LABEL: "text-sm text-gray-500 mr-2"
  },
  QUICK_ADD: {
    WRAPPER: "flex space-x-2 w-full sm:w-auto mt-4 sm:mt-0",
    INPUT_WRAPPER: "relative w-full sm:w-auto",
    INPUT: "border border-gray-300 rounded-l-md px-4 py-2 w-full sm:w-64 bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500",
  ...
  TABLE: {
    WRAPPER: "flex-1 overflow-y-auto overflow-x-auto",
    ...
    TH: "px-3 sm:px-6 py-3 border-b",
    ROW: "hover:bg-gray-50 group",
    TD: "px-3 sm:px-6 py-3",
    ...
    ACTIONS: "flex justify-end space-x-2 md:opacity-0 group-hover:opacity-100 transition-opacity",
